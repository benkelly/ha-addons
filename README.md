...
- The AIOStreams, Remux and Tvheadend icons and logos are derived from their
  upstream logos (AIOStreams GPL-3.0, Remux AGPL-3.0, Tvheadend GPL-3.0). UHF
  Server ships no branding assets, so that add-on has none.
